...
export const RELATED_POSTS_PER_PAGE = 2;

export const MIN_MATCH_CHAR_LENGTH = 3;

export const DEFAULT_PAGE_TITLE = 'Blog huyknguyendotcom';
...
export const APP_NAME = 'huyknguyendotcom';

export const APP_DOMAIN = 'https://blog.huyknguyen.com';
